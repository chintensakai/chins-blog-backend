package com.chins.blog.backend.cache.config;

import com.alibaba.fastjson.parser.ParserConfig;
import com.chins.blog.backend.cache.serializer.FastJsonRedisSerializer;
...
//    设置key value的序列化规则
  ...
  public CacheManager cacheManager(RedisConnectionFactory factory) {
    ...
    ParserConfig.getGlobalInstance().addAccept("com.chins");
